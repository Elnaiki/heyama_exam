...
exports.ObjectsGateway = void 0;
var websockets_1 = require("@nestjs/websockets");
var ObjectsGateway = function () {
    ...
    var ObjectsGateway = _classThis = /** @class */ (function () {
        function ObjectsGateway_1() {
            this.server = __runInitializers(this, _server_initializers, void 0);
            __runInitializers(this, _server_extraInitializers);
        }
        ObjectsGateway_1.prototype.notifyNewObject = function (object) {
            this.server.emit('newObject', object);
        };
        return ObjectsGateway_1;
    }());
    __setFunctionName(_classThis, "ObjectsGateway");
    (function () {
        ...
        ObjectsGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ObjectsGateway = _classThis;
}();
exports.ObjectsGateway = ObjectsGateway;
