...
const styles = StyleSheet.create({
  ...
  form: { padding: 16 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#1e40af', marginBottom: 12, marginTop: 8 },
  input: { borderWidth: 1, borderColor: '#bfdbfe', borderRadius: 10, padding: 12, marginBottom: 10, backgroundColor: '#fff', color: '#1e293b', fontSize: 15 },
  imageButton: { borderWidth: 1, borderColor: '#2563eb', borderRadius: 10, padding: 12, alignItems: 'center', marginBottom: 10, backgroundColor: '#eff6ff' },
  imageButtonText: { color: '#2563eb', fontWeight: '600' },
  preview: { width: '100%', height: 180, borderRadius: 10, marginBottom: 10 },
  createButton: { backgroundColor: '#2563eb', borderRadius: 10, padding: 14, alignItems: 'center', marginBottom: 20 },
  createButtonDisabled: { backgroundColor: '#93c5fd' },
  createButtonText: { color: '#fff', fontWeight: 'bold', fontSize: 16 },
  list: { paddingHorizontal: 16, paddingBottom: 20 },
  card: { backgroundColor: '#fff', borderRadius: 12, marginBottom: 14, overflow: 'hidden', borderWidth: 1, borderColor: '#dbeafe', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
  ...
  deleteButton: { backgroundColor: '#fee2e2', borderRadius: 8, padding: 8, alignItems: 'center' },
